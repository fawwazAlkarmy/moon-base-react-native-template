...
const inputTv = tv({
  slots: {
    ...
    input:
      "mt-0 rounded-xl border-[0.5px] border-neutral-300 bg-neutral-100 px-4 py-3 font-inter leading-5 dark:border-neutral-700 dark:bg-neutral-800 dark:text-white",
  },
